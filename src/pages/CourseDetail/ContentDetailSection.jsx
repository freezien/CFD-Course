      ...
      <section className="contentdetail">
        <div className="content">
          <div className="container">
            ...
            <div className="contentrow ctlession" ref={courseRef}>
              <h3 className="contentrow__title title --t3">
                Nội dung khoá học
              </h3>
              {content?.length > 0 && <Accordion data={modifiedContent} />}
            </div>
            <div className="contentrow ctrequest">
              ...
              <div className="ctrequest__content">
                {required?.length > 0 &&
                  required.map((item, index) => <p key={index}> {item}</p>)}
              </div>
            </div>
              ...
              <div className="ctteacher__content">
                {teams?.length > 0 &&
                  teams.map((item, index) => {
                    const { id, name, description, jobTitle, image, tags } =
                      item || {};
                    return (
