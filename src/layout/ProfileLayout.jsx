...
const ProfileLayout = () => {
  ...
  const { profileInfo, handleGetProfilePayment, handleGetProfileCourse } =
    useAuthen({});
              ...
              <div className="tab">
                ...
                <div className="tab__content">
                  ...
                  <Outlet
                    ...
                    handleGetProfileCourse={handleGetProfileCourse}
                    handleGetProfilePayment={handleGetProfilePayment}
                  />
                </div>
              </div>
            </div>
